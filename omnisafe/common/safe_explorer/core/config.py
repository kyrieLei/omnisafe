...
import copy
import yaml
from omnisafe.common.safe_explorer.utils.namespacify import Namespacify
from omnisafe.common.safe_explorer.utils.path import get_project_root_dir
...
class Config:
    ...
    def _load_config(cls, args=None):
        ...
        config_file_path = f"/Users/kyrie/Desktop/omnisafe/omnisafe/common/safe_explorer/core/defaults.yml"
