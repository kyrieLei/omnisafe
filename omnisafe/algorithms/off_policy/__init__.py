...
from omnisafe.algorithms.off_policy.sddpg_modular import SDDPG_Modular
...
__all__ = ['DDPG', 'TD3', 'SAC', 'DDPGLag', 'TD3Lag', 'SACLag', 'DDPGPID', 'TD3PID', 'SACPID','SDDPG','SDDPG_Modular']
